          ...
          <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
              ...
              <div class="jb_job_post_right_cont">
                ...
                <ul>
                  <li>
                    <i class="flaticon-cash"></i>&nbsp; N1200000 - N500000 P.A.
                  </li>
                  <li>
                    <i class="flaticon-location-pointer"></i>&nbsp; Lagos,
                    Nigeria, 455001
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
              ...
              <div class="jb_job_post_right_cont">
                ...
                <ul>
                  <li>
                    <i class="flaticon-cash"></i>&nbsp; N1000000 - N1500000 P.A.
                  </li>
                  <li>
                    <i class="flaticon-location-pointer"></i>&nbsp; Garki, Abuja
                    Nigeria
                  </li>
                </ul>
              </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
              ...
              <div class="jb_job_post_right_cont">
                ...
                <ul>
                  ...
                  <li>
                    <i class="flaticon-location-pointer"></i>&nbsp; Los Angeles,
                    Califonia PO, 455001
                  </li>
                </ul>
              </div>
