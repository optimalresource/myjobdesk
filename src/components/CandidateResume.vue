  ...
  <div>
    ...
    <div class="cp_navi_main_wrapper jb_cover">
      <div class="container-fluid">
        ...
        <header
          class="mobail_menu d-block d-sm-block d-md-block d-lg-none d-xl-none"
        >
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
        ...
        <div class="jb_navigation_wrapper">
          <div
            class="mainmenu d-xl-block d-lg-block d-md-none d-sm-none d-none"
          >
                ...
                <ul class="navi_2_dropdown">
                  <li class="parent">
                    <a href="../main_pages/index.html"
                      ><i class="fas fa-square"></i>home I
                    </a>
                  </li>
                  <li class="parent">
                    <a href="../main_pages/index_II.html"
                      ><i class="fas fa-square"></i>home II</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/index_III.html"
                      ><i class="fas fa-square"></i> home III</a
                    >
                  </li>
                </ul>
              </li>
                ...
                <ul class="navi_2_dropdown">
                  <li class="parent">
                    <a href="../main_pages/job_listing_grid_left_filter.html">
                      <i class="fas fa-square"></i>job listing grid
                    </a>
                  </li>
                  <li class="parent">
                    <a href="../main_pages/job_listing_list_left_filter.html">
                      <i class="fas fa-square"></i>job listing list
                    </a>
                  </li>
                  <li class="parent">
                    <a href="../main_pages/job_single.html">
                      <i class="fas fa-square"></i>job single</a
                    >
                  </li>
                  ...
                  <li class="parent">
                    ...
                    <ul class="dropdown-menu-right">
                      <li>
                        <a
                          href="../main_pages/job_listing_grid_left_filter.html"
                        >
                          <i class="fas fa-square"></i>job listing grid
                        </a>
                      </li>
                      <li>
                        <a
                          href="../main_pages/job_listing_list_left_filter.html"
                        >
                          <i class="fas fa-square"></i>job listing list
                        </a>
                      </li>
                        ...
                        <div class="candidate_width">
                          <div class="jen_tabs_conent_list jb_cover">
                            ...
                            <ul>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>HTML5 & CSS3</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>wordpress</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>javascript</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>photoshop</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>designer</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>construction</a
                                >
                              </li>
                            </ul>
                          </div>
                        ...
                        <div class="candidate_width">
                          <div class="jen_tabs_conent_list jb_cover">
                            ...
                            <ul>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>graphic
                                  design</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>engineering
                                  jobs</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>mainframe
                                  jobs</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>PSU jobs</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>goverment
                                  jobs</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>IT company</a
                                >
                              </li>
                            </ul>
                          </div>
                        ...
                        <div class="candidate_width">
                          <div class="jen_tabs_conent_list   jb_cover">
                            ...
                            <ul>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>india</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>united state</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>japan</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>dubai</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>south africa</a
                                >
                              </li>
                              <li>
                                <a href="#"
                                  ><i class="fas fa-square"></i>china</a
                                >
                              </li>
                            </ul>
                          </div>
                            ...
                            <div class="open_jobs_wrapper">
                              <div class="open_jobs_wrapper_1 jb_cover">
                                ...
                                <div class="open_job_text">
                                  <h3>
                                    <a href="#"
                                      >Some designers inelevated the..</a
                                    >
                                  </h3>
                                  <p>5 hour ago</p>
                                </div>
                ...
                <ul class="navi_2_dropdown">
                  <li class="parent">
                    <a href="../main_pages/about_us.html">
                      <i class="fas fa-square"></i>about us</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/companies.html">
                      <i class="fas fa-square"></i>companies</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/company_single.html">
                      <i class="fas fa-square"></i>company single</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/error_page.html"
                      ><i class="fas fa-square"></i>error page</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/login.html"
                      ><i class="fas fa-square"></i>login</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/pricing_table.html"
                      ><i class="fas fa-square"></i>pricing table</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/sign_up.html"
                      ><i class="fas fa-square"></i>sign_up</a
                    >
                  </li>
                </ul>
              </li>
                    ...
                    <ul class="dropdown-menu-right">
                      <li>
                        <a href="candidate_applied_job.html">
                          <i class="fas fa-square"></i>applied job
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="candidate_favourite_job.html">
                          <i class="fas fa-square"></i>favourite job</a
                        >
                      </li>
                      <li>
                        <a href="candidate_resume.html">
                          <i class="fas fa-square"></i>resume</a
                        >
                      </li>
                      <li>
                        <a href="message.html">
                ...
                <ul class="navi_2_dropdown">
                  <li class="parent">
                    <a href="../main_pages/blog_single.html">
                      <i class="fas fa-square"></i>blog single</a
                    >
                  </li>
                  <li class="parent">
                    <a href="../main_pages/blog_category_right_sidebar.html">
                      <i class="fas fa-square"></i>blog category</a
                    >
                  </li>
                </ul>
              </li>
          ...
          <!-- mainmenu end -->
          <div
            class="jb_search_btn_wrapper d-none d-sm-none d-md-none d-lg-block d-xl-block"
          >
            <!-- extra nav -->
            <div class="extra-nav">
            ...
            <div class="row">
                  ...
                  <div class="job_overview_header jb_cover">
                    <div class="row">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          {{ educations.grade }}
                            ...
                            >
                              <p>
                                {{ updatedreferree.full_name }},
                                {{ updatedreferree.phone_number }}
                                {{ updatedreferree.company_position }},
                                {{ updatedreferree.company_name }}
                                {{ updatedreferree.email }}
                              </p>
                            </div>
                            <br />
                            <hr />
                            ...
                            >
                              ...
                              <p>{{ updatedexperience.company_name }}</p>
                              <p>{{ updatedexperience.jd }}</p>
                              <p>{{ updatedexperience.date_from }}</p>
                              <p>{{ updatedexperience.date_to }}</p>
                            </div>
                            <br />
                            <hr />
                      ...
                      <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <!-- This would be the left part of the cv -->
                      </div>

                      <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <!-- This should be the left part of the cv -->
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="delett_cntn jb_cover">
                              <h1>
                                <i class="fas fa-edit"></i>Edit personal
                                information
                              </h1>
                              ...
                              <div class="header_btn search_btn applt_pop_btn">
                                <button @submit.prevent="updateForm">
                                  update
                                </button>
                              </div>
                              <div class="cancel_wrapper">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="delett_cntn jb_cover">
                              <h1>
                                <i class="fas fa-edit"></i>add certificates
                              </h1>
                              <div class="category_wrapper jb_cover">
                                <div class="row">
                                  <div
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="delett_cntn jb_cover">
                              <h1><i class="fas fa-edit"></i>Add Referees</h1>
                              <div class="category_wrapper jb_cover">
                                <div class="row">
                                  <div
                                    class="col-lg-9 col-md-9 col-sm-12 col-12"
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                >
                  <div class="job_filter_sidebar_heading jb_cover">
                    <h1>
                      Tell us a little about yourself<span
                        ...
                        <div class="modal-content">
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="delett_cntn jb_cover">
                                <h1>
                                  <i class="fas fa-edit"></i>Write something
                                  Catchy about yourself
                                </h1>
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="delett_cntn jb_cover">
                              ...
                              <div
                                class="category_wrapper gallery_browse jb_cover"
                              >
                                <div class="row">
                                  <div
                                    class="col-lg-3 col-md-3 col-sm-12 col-12"
                                  >
                                    <div class="category_lavel jb_cover"></div>
                                  </div>
                                  <div
                                    class="col-lg-9 col-md-9 col-sm-12 col-12"
                                  >
                                    ...
                                    <div class="delete_jb_form gallery_link">
                                      <textarea
                                        name="message"
                                        rows="2"
                                        placeholder="Program Type*  e.g. HnD, BSc, PhD "
                                        required
                                      ></textarea>
                                    </div>
                                  </div>
                ...
                >
                  ...
                  <div class="job_overview_header jb_cover">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div
                          class="jp_listing_overview_list_main_wrapper education_board jb_cover"
                        >
                          <div class="jp_listing_list_icon_cont_wrapper">
                            <ul>
                              <li>
                              ...
                              <li>
                                <!-- {{ experiences.title }}
                        <a href="#"> {{ experiences.company_name }}</a> -->
                              </li>
                            </ul>
                            <p>
                              <!-- {{ experiences.jd }} -->
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <ul class="speical_qualification_wrapper">
                  <li>
                    <i class="fas fa-check-square"></i>{{ edit.special_skills }}
                  </li>
                  <li>
                    <i class="fas fa-check-square"></i>Skilled at any Kind
                    Design Tools.
                  </li>
                  <li>
                    <i class="fas fa-check-square"></i>Passion for
                    people-centered design, solid intuition.
                  </li>
                  <li>
                    <i class="fas fa-check-square"></i>Hard Worker & Quick
                    Lerner.
                  </li>
                </ul>
              </div>
...
export default {
  ...
  methods: {
    ...
    secondStep() {
      ...
      //   this.$toastr.e("please fill Personal Details");
      //   return false;
      // }
      if (this.eDResponse != 200) {
        this.$toastr.e("please add an Educational Detail");
        return false;
      }
    ...
    savecv() {
      ...
      if (this.cvPreview.length > 0) {
        ...
        this.$toastr.e("Please upload a cv before submitting");
        return false;
      }
      ...
      axios
        ...
        .then(response => {
          ...
          if (response.status == "200") {
            this.$toastr.s("CV saved successfully");
            return true;
          } else {
            this.$toastr.e(
              "Oops, something went wrong, please try again later"
    ...
    saveskills() {
      ...
      if (this.skills.skill == "") {
        this.$toastr.e("Please enter a skill");
        return false;
      }
    ...
    savereferrers() {
      ...
      if (this.referrers.phone == "") {
        this.$toastr.e("Please Fill Your Referee's number");
        return false;
      }
      ...
      if (this.referrers.company_name == "") {
        this.$toastr.e("Please Fill Your Referee's Company's name ");
        return false;
      }
      if (this.referrers.email == "") {
        this.$toastr.e("Please Fill Your Referee's email");
        return false;
      }
      if (this.referrers.full_name == "") {
        this.$toastr.e("Please Fill Your Referee's Full Name");
        return false;
      }
      var reff = {};
    ...
    save_certificate() {
      ...
      if (this.certifications.title == "") {
        this.$toastr.e("Please fill Certification Title");
        return false;
      }
      if (this.certifications.description == "") {
        this.$toastr.e("Please fill Certification Description");
        return false;
      }
      ...
      if (this.certPreview.length > 0) {
        ...
        this.$toastr.e("Please upload a file before submitting");
        return false;
      }
