      ...
      <ul class="cd-dropdown-content">
        ...
        <li class="has-children">
          ...
          <ul class="cd-secondary-dropdown icon_menu is-hidden">
            ...
            <li>
              <a href="../main_pages/pricing_table.html">pricing table</a>
            </li>
            ...
            <div class="emp_dashboard_sidebar jb_cover">
              ...
              <div class="emp_follow_link jb_cover">
                <ul class="feedlist">
                  ...
                  <li>
                    <a href="pricing_plans.html" class="link_active"
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="pricing-controller">
                  ...
                  <span class="duration duration-year"
                    >Annually <span>(Save 10%)</span></span
                  >
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="pricing_box_wrapper jb_cover">
                  ...
                  <div class="main_pdet jb_cover">
                    <h2 class="monthly-rate">
                      <span class="dollarr"> $ </span> 29
                    </h2>
                    <span class="monthly monthly-rate"> / per month</span>
                    <h2 class="yearly-rate hidden">
                      <span class="dollarr"> $ </span> 299
                    </h2>
                    <span class="monthly yearly-rate hidden"> / yearly</span>
                  </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="pricing_box_wrapper jb_cover">
                  ...
                  <div class="main_pdet jb_cover">
                    <h2 class="monthly-rate">
                      <span class="dollarr"> $ </span> 59
                    </h2>
                    <span class="monthly monthly-rate"> / per month</span>
                    <h2 class="yearly-rate hidden">
                      <span class="dollarr"> $ </span> 599
                    </h2>
                    <span class="monthly yearly-rate hidden"> / yearly</span>
                  </div>
                  <ul class="pricing_list22">
