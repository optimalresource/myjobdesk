              ...
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="our_blog_content jb_cover">
                  ...
                  <div class="blog_content jb_cover">
                    ...
                    <h4>
                      <a href="#"
                        >Want to Be an Ace Designer? Try Travelling the World</a
                      >
                    </h4>
                  </div>
                </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="our_blog_content jb_cover">
                  ...
                  <div class="blog_content jb_cover">
                    ...
                    <h4>
                      <a href="#"
                        >Hey Seeker, It’s Time to Try Travelling the World</a
                      >
                    </h4>
                  </div>
                </div>
                      ...
                      <div class="card-body">
                        <div class="card_cntnt">
                          <p>
                            ...
                            nibh vel velit auctor Ipsum. Proin gravida nibh vel
