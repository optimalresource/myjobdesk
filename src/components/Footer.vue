        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="footerNav jb_cover footer_border_displ">
              ...
              <ul class="nav-widget">
                ...
                <li>
                  <a href="#"><i class="fa fa-square"></i>Client Portal </a>
                </li>

                <li>
                  <a href="#"><i class="fa fa-square"></i> Powerful Workflow</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="footerNav jb_cover footer_border_displ">
              ...
              <ul class="nav-widget">
                <li>
                  <a href="#"
                    ><i class="fa fa-square"></i>Freelancers by Category</a
                  >
                </li>
                ...
                <li>
                  <a href="#"><i class="fa fa-square"></i> Freelancers in UK</a>
                </li>

                <li>
                  <a href="#"
                    ><i class="fa fa-square"></i> Freelancers in Canada</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="fa fa-square"></i> Freelancers in india</a
                  >
                </li>
                <li>
                  <a href="#"><i class="fa fa-square"></i> find jobs</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="footerNav jb_cover footer_border_displ">
              ...
              <ul class="nav-widget">
                <li>
                  <a href="#"><img src="images/ft1.png" alt="img" />Xero </a>
                </li>

                <li>
                  <a href="#"><img src="images/ft2.png" alt="img" />Reckon </a>
                </li>

                <li>
                  <a href="#"
                    ><img src="images/ft3.png" alt="img" />Flexidocs
                  </a>
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"><img src="images/ft6.png" alt="img" /> MYOB </a>
                </li>
              </ul>
            </div>
          </div>
